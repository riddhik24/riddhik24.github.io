...
export default function BlogDetails() {
  ...
  return (
    <section className="py-20 md:py-28 min-h-screen bg-light-bg dark:bg-dark-bg">
      <div className="container mx-auto px-4 md:px-8 pt-16 max-w-4xl">
        <div
        ...
        >
          <div className="p-6 md:p-8">
            ...
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-light-text dark:text-dark-text mt-2 mb-4">
              {filteredBlog?.title}
            </h2>
          </div>
          <div className="px-6 md:px-8 pb-8">
            {filteredBlog ? (
              <div>
                <h4 className="text-accent font-heading font-bold mb-3">Answer</h4>
                <p className="text-light-text-secondary dark:text-dark-text-secondary text-lg leading-relaxed">
